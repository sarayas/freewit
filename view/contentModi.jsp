...
<hr color="#000000"/>
	<div class="clearfix">
		...
		<form name="content" action="<%=request.getContextPath()%>/contentController"
				method="post" onsubmit="return validationForm()" enctype="multipart/form-data"><br>
				<table align="center">
					<tr>
				...
				<input type="hidden" name="authoruty" value="2"/>
