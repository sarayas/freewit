...
<html>
	...
	<body style="background-image: linear-gradient(to top, #D7D2FF 0%, white 100%);">
		...
		<div class="container">
			<h2 align="center"><%=contentList.get(0).getId() %>様のコンテンツ</h2>
			<hr color="#000000" />
			<div class="clearfix">
			...
			<table bordercolor="#000000">
			 ...
			 %>
					<form action="<%=path%>/followController" method="post"><input
						type="hidden" name="follow" value="<%=content.getId()%>" /> <input
						type="hidden" name="fCmd" value="1" /> <input type="submit"
						value="フォローする" ;/></form>
					<%
						}
					%>
